...
export const ADMIN_HOST = (`${window.apiHost}` == 'http://api.volzdx.cn') || (`${window.apiHost}` == 'https://api.volzdx.cn') ? 'http://admin.volzdx.cn' : 'http://api.admin.volunteer.alpha.flashdiet.cn';

// 'http://api.admin.volunteer.alpha.flashdiet.cn';
// http://api.volunteer.alpha.flashdiet.cn
// http://api.volzdx.cn