    ...
    return (
      <div className="page-login-box">
        ...
        <div className="page-login-agree">
          {
            window.orgCode == "yMYerkEaOB" ? <div style={{ width: 15, height: 15, background: `${this.state.checked ? "url('../images/check_box_select_login.png')" : "url('../images/check_box_login.png')"}`}} onClick={() => { this.setSate({ checked: !checked }) }} /> : null
          }
          {
