...
class TeamDetailPage extends React.Component {
    ...
    renderSlick() {
        ...
        if (!detailData || !detailData.team_photo) {
            return <Image className="team-photo" src={detailData.logo} alt="团队图片"
    ...
    renderBasic() {
        ...
        return (<div>
                        ...
                        <div className="header-addition-new">
                            <div className="team-info">
                                ...
                                <div className="header-addition-new-container">
                                    <div className="header-addition-new-container-title"><span>{detailData.name}</span>
                                    </div>
                                    <div className="header-addition-new-container-star"><Star
                                        size={{width: 15, height: 14, score: detailData.stars}} isBlockEmptyStar/></div>
                                </div>
                            </div>
            ...
            <div className="foot">
                ...
                {
                    window.userAgent && window.userAgent
                        ?
            ...
            <div>
                {
                    this.props.feeling.data && this.props.feeling.data.list && this.props.feeling.data.list.length > 0 && this.props.feeling.type == 'team' ? this.props.feeling.data.list.map(listData => (
                            <CommunityItem
                                data={listData} isDetailEntry={false} key={listData.id} routeData={this.props.route}
                                isDescTrigger={false}
                ...
                <Dialog type="ios" title={this.dialogA.title} buttons={this.dialogA.buttons}
